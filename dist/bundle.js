/******/ (() => {
  ...
  \*****************************************/
      /***/ (
        ...
        /* harmony import */ var _base_component__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
        ...
        class ProjectInput extends _base_component__WEBPACK_IMPORTED_MODULE_0__.Component {
          ...
          gatherUserInput() {
            ...
            if (
              !(0, _util_validation__WEBPACK_IMPORTED_MODULE_1__.validate)(
                titleValidatable
              ) ||
              !(0, _util_validation__WEBPACK_IMPORTED_MODULE_1__.validate)(
  ...
  \****************************************/
      /***/ (
        ...
        /* harmony import */ var _models_project_model__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../models/project-model */ './src/models/project-model.ts'
          );
        /* harmony import */ var _decorators_autobind__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ../decorators/autobind */ './src/decorators/autobind.ts'
        ...
        /* harmony import */ var _project_item__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            /*! ./project-item */ './src/components/project-item.ts'
          );
        var __decorate =
          (undefined && undefined.__decorate) ||
          function (decorators, target, key, desc) {
        ...
        class ProjectList extends _base_component__WEBPACK_IMPORTED_MODULE_0__.Component {
          ...
          dropHandler(event) {
            ...
            _state_project_state__WEBPACK_IMPORTED_MODULE_3__.projectState.moveProject(
              prjId,
              this.type === 'active'
                ? _models_project_model__WEBPACK_IMPORTED_MODULE_1__
          ...
          configure() {
            ...
            _state_project_state__WEBPACK_IMPORTED_MODULE_3__.projectState.addListener(
              (projects) => {
          ...
          renderProjects() {
            ...
            for (const prjItem of this.assignedProjects) {
              new _project_item__WEBPACK_IMPORTED_MODULE_4__.ProjectItem(
  ...
  \************************************/
      /***/ (
        ...
        /* harmony import */ var _models_project_model__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../models/project-model */ './src/models/project-model.ts'
          );
        ...
        class ProjectState extends State {
          ...
          addProject(title, description, numOfPeople) {
            const newProject =
              new _models_project_model__WEBPACK_IMPORTED_MODULE_0__.Project(
                Math.random().toString(),
                title,
                description,
                numOfPeople,
                _models_project_model__WEBPACK_IMPORTED_MODULE_0__.ProjectStatus.Active
              );
